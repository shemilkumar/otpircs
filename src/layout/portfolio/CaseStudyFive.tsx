        ...
        <>
            <Container>
                <div className="relative mb-40">
                    <div className="flex">
                        <img src="/img/3D Desktop Screen Mockups.png" alt="" className="w-[70%] border-purple-500 z-10" />
                    </div>

                    <div className="absolute inset-0 flex flex-col justify-start items-end p-6 ">
                        ...
                        <div className="pt-48 pl-16 w-1/3">
                            ...
                            <p className="relative text-lg mt-4">
                                Explore our cutting-edge portfolio featuring responsive web designs, intuitive mobile applications, and seamless user experiences. Each project is crafted with attention to detail.
                            </p>
